...
# ------------------------------------------------------
nodeId=0
cassandra_home="/Users/Shared/research/src/cassandra-fi"
FM_MY_JARS="/Users/haryadi/local/apps/java-rtjar"
...
nodeIpLast=`expr 2 + $nodeId`
nodeIp="127.0.0.$nodeIpLast"
nodeAddr="$nodeIp:$nodePort"
jmxPort=`expr 8082 + $nodeId`

echo "Enter password for this command:"
echo "sudo ifconfig lo0 alias $nodeIp up"
