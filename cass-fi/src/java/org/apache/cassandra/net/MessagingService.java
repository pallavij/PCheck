...
public class MessagingService implements IFailureDetectionEventListener
{
  ...
  protected MessagingService()
  {
    ...
    //JINSU: MAJOR HACK
    //REGISTER WITH FAILURE DETECTOR SO MessagingService CAN CONVICT DEADNODES TOO.
  ...
  public void convict(InetAddress ep)
  {
    ...
    Util.debug("    - MS.convict " + ep + " is now dead.");
  }
  ...
  public void listen(InetAddress localEp) throws IOException
  {
    ...
    System.out.println("  Listening on port: " + 
		       localEp + " : " + DatabaseDescriptor.getStoragePort());
  ...
  public String sendRR(Message message, InetAddress[] to, IAsyncCallback cb)
  {
    ...
    for (InetAddress endpoint : to)
      {
      	Util.debug("sendRR ms line 213 sendoneway");
  ...
  public String sendRR(Message message, InetAddress to, IAsyncCallback cb)
  {
    ...
    Util.debug("sendRR ms line 239 sendoneway");
  ...
  public void sendOneWay(Message message, InetAddress to)
  {
    ...
    // System.out.println("sendOneWay is being used!!!!!");
		//JINSU: print out what message is being sent
		Util.debug(new Date(System.currentTimeMillis()) + " - sending this message =>" + " To = " + to + " Type = " + message.getMessageType() + " Verb = " + message.getVerb());
		
		//System.out.println("&&&hello, sendoneway!!!");
    // do local deliveries
  ...
  public IAsyncResult sendRR(Message message, InetAddress to)
  {
    ...
    Util.debug("sendRR ms line 325 sendoneway");
    sendOneWay(message, to);
    return iar;
  }
