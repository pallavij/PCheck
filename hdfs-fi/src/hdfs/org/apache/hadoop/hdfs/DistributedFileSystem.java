...
public class DistributedFileSystem extends FileSystem {
  ...
  // **************************************************
  // haryadi, thanh, my hack to get the block ID, pallavi-15
  // **************************************************
  public Block[] getBlocks(FileStatus file, long start,
                           long len) throws IOException {
    if (file == null) {
      return null;
    }
    return dfs.getBlocks(getPathName(file.getPath()), start, len);
  }
  // **************************************************
  ...
  // ***************************************
  // haryadi's hack: to make sure we can get the block ID
  // ***************************************
