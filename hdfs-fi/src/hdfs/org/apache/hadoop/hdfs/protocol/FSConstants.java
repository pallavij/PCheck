...
public interface FSConstants {
  ...
  //haryadi, pallavi, disable/prolong lease recovery (3 hours), bad hack
  //public static final long LEASE_SOFTLIMIT_PERIOD = 60 * 1000;
  public static final long LEASE_SOFTLIMIT_PERIOD = 10000 * 1000;
  public static final long LEASE_HARDLIMIT_PERIOD = 60 * LEASE_SOFTLIMIT_PERIOD;
  
  // *********************************************************
  // haryadi, pallavi, hack ... lease_recover_period to 10 
  // we need to set this to really small, because we're reducing
  // the number of client retries ... if we don't reduce this ... 
  // then we must wait 10 seconds for every experiment ...
  // *********************************************************
  public static final long LEASE_RECOVER_PERIOD = 10; //in ms  
  // *********************************************************
  // original line:
