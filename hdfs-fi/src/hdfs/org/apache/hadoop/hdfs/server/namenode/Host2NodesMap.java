...
class Host2NodesMap {
  ...
  DatanodeDescriptor getDatanodeByHost(String host) {
    ...
    try {
      ...
      // ******************************************************
      // haryadi, hack, remove randomness, deterministic (Place 1)
      DatanodeDescriptor returnedNode = nodes[r.nextInt(nodes.length)];
      returnedNode = HdfsFiUtil.returnFirstNode(returnedNode, nodes);
      return returnedNode;
      // ******************************************************
      // original line:
