...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  public LocatedBlock addBlock(String src,
    ...
    // pallavi-16, print returning located block
    FIUtil.debug(">> NN.addBlock, returning " + locatedBlock);
  ...
  public void finalizeUpgrade() throws IOException {
    ...
    FIUtil.debug(">> NN.finalizeUpgrade(), ... ");
  ...
  private static boolean finalize(Configuration conf,
    ...
    FIUtil.debug(">> NN.finalize, will begin ");
  ...
  private static StartupOption parseArguments(String args[]) {
    ...
    FIUtil.debug("- NN.parse, startOpt is " + startOpt.toString());
  ...
  private static void setStartupOption(Configuration conf, StartupOption opt) {
    ...
    FIUtil.debug("- NN.sso, dfs.namenode.startup is " + opt.toString());
  ...
  public static NameNode createNameNode(String argv[], 
	...
	FIUtil.debug("- NN.createNN (10), finalize exiting ...");
        System.exit(aborted ? 1 : 0);
      default:
    }
