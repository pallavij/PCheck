...
public aspect weavert {
  ...
  declare parents: DatagramPacket implements ClassWC;   // >>> JASON <<< 
  declare parents: ByteBuffer implements ClassWC;   // >>> PALLAVI <<< 
  ...
  // >>> JASON <<<
  public Context DatagramPacket.context = null;
  public Context DatagramPacket.getContext() { return context; }
  public void DatagramPacket.setContext(Context x) { context = x; }
  
  // >>> PALLAVI <<<
  public Context ByteBuffer.context = null;
  public Context ByteBuffer.getContext() { return context; }
  public void ByteBuffer.setContext(Context x) { context = x; }
