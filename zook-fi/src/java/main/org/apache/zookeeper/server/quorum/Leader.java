...
public class Leader {
    ...
    void lead() throws IOException, InterruptedException {
		...
		LOG.info("Going to sleep in lead()");
                Thread.sleep(self.tickTime);
                self.tick++;
            }

	    //PALLAVI: elected leader is now leading; this function is added to make detection of the end 
	    //of leader election easier	
	    leaderIsNowLeading();
    ...
    void leaderIsNowLeading(){
    
	    LOG.info("In leaderIsNowLeading");
