...
public class QuorumPeer extends Thread implements QuorumStats.Provider {
    ...
    protected Election createElectionAlgorithm(int electionAlgorithm){
		...
		MyUtil.debug(">>>>> JASON <<<<< in QuorumPeer.java approx 524. electionAlg is: "+getElectionType());
            ...
            while (running) {
                ...
                case LOOKING:
                    try {
                    	...
                    	MyUtil.debug("Going to look for a leader ---- 1");
                ...
                case OBSERVING:
                    try {
                        ...
                        observer.shutdown();
                        setObserver(null);
                    	MyUtil.debug("Going to look for a leader ---- 2");
                        setPeerState(ServerState.LOOKING);
                    }
                    break;
                case FOLLOWING:
                    try {
                        ...
                        follower.shutdown();
                        setFollower(null);
                    	MyUtil.debug("Going to look for a leader ---- 3");
                        setPeerState(ServerState.LOOKING);
                    }
                    break;
                case LEADING:
                    ...
                    try {
                    	...
                    	MyUtil.debug("Going to look for a leader ---- 4");
                        setPeerState(ServerState.LOOKING);
                    }
                    break;
                }
