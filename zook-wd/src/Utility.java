...
public class Utility {
  ...
  public boolean mkDir(File dir) {
    ...
    print("   Mkdir " + dir.getAbsolutePath());
  ...
  // **************************************
  public boolean stringToFileContent(String buf, String path, boolean flush) {
    return stringToFileContent(buf, new File(path), flush, false);
  }
  ...
  // **************************************
  public boolean stringToFileContent(String buf, String path, boolean flush, boolean append) {
    return stringToFileContent(buf, new File(path), flush, append);
  }
